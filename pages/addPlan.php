...
//    '_id' => $id
//);
//$disablePlan = $planManager->findAndModify($criteria, array('state' => 1), NULL, array('new' => TRUE));
if (!empty($allPlan))
{
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    <li><a href="plan.php"><i class="fa fa-angle-double-right"></i> List plan</a></li>
                    <li><a href="addPlan.php"><i class="fa fa-angle-double-right"></i> Add plan</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
            ...
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <div class="box-body table-responsive">
                        <form  class="form-horizontal" role="form" method="POST" action="../controller/addPlan.php">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-2">
                                    <input name="maxStorage" type="number" class="form-control" id="maxStorage" placeholder="Maximum storage">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="downL" class="col-sm-2 control-label">Download speed(Kb)</label>
                                <div class="col-sm-2">
                                    <input name="downL" type="number" class="form-control" id="downL" placeholder="Download speed">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="upL" class="col-sm-2 control-label">Upload speed(Kb)</label>
                                <div class="col-sm-2">
                                    <input name="upL" type="number" class="form-control" id="upL" placeholder="Upload speed">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="maxRatio" class="col-sm-2 control-label">Max ratio</label>
                                <div class="col-sm-2">
                                    <input name="maxRatio" type="number" class="form-control" id="maxRatio" placeholder="Maximum ratio">
                                </div>
                            </div>

                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    <button name="add_plan" class="btn btn-success" type="submit" class="btn btn-default">Add plan</button>
                                </div>
                            </div>
                        </form>
                    </div><!-- /.box-body -->
