...
$allUser = $userManager->findAll();
$allPlan = $planManager->findAll();

//Compte le nbr de user en bdd
$countUser = count($allUser);

//Compte le nbr de plan en bdd
$countPlan = count($allPlan);
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-aqua">
                                ...
                                <a href="pages/plan.php" class="small-box-footer">
